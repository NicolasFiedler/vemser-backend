...
public class ProdutorService {
    ...
    public void enviarMensagem(SensoresCreateDTO sensoresDTO) throws JsonProcessingException {

        SensoresEntity sensoresEntity = objectMapper.convertValue(sensoresDTO, SensoresEntity.class);
        sensoresEntity.setDataLeitura(LocalDateTime.now());
        String mensagem = objectMapper.writeValueAsString(sensoresEntity);
